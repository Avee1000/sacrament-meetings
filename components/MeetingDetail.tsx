...
export default function MeetingDetail({ meeting }: MeetingDetailProps) {
  ...
  return (
    <article className="border w-full border-slate-200 rounded-xl shadow-lg bg-white flex flex-col transition-all hover:shadow-xl overflow-y-auto max-h-[80dvh]">
