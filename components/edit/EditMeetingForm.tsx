...
import { SacramentMeeting, MeetingType } from "@/lib/types";
...
export default function EditMeetingForm({ onSuccess, sacrament }: FormProps) {
    const router = useRouter();
    const [state, formAction] = useActionState(
        updateSacramentMeeting.bind(null, sacrament.id),
        initialState
    );

    // Complex state handlers matching database structure
    const [speakers, setSpeakers] = useState<SpeakerInputRow[]>(
        (sacrament.speakers ?? []).map((speaker) => ({
            name: speaker.name,
            topic: speaker.topic,
            type: speaker.type,
        }))
    ...
    const [wardBusiness, setWardBusiness] = useState<BusinessInputRow[]>(
        (sacrament.wardBusiness ?? []).map((item) => ({
    ...
    const [stakeBusiness, setStakeBusiness] = useState(sacrament.stakeBusiness);
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center justify-between">
                            <div>
                                ...
                                <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Edit & Update Meeting Program</h1>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        defaultValue={sacrament.presiding}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        defaultValue={sacrament.conducting}
                                    />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        defaultValue={sacrament.openingPrayer}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        defaultValue={sacrament.closingPrayer}
                                    />
                        ...
                        <div>
                            ...
                            <div className="mt-4 flex items-center gap-2">
                                <Checkbox
                                    ...
                                    defaultChecked={sacrament.stakeBusiness}
